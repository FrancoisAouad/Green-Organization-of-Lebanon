                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                           ...
                           // newposts.put("profileimage", pfp);
                            ...
                            postRef.updateChildren(newposts).addOnCompleteListener(new OnCompleteListener() {
                                @Override
                                public void onComplete(@NonNull Task task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(writeActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
                                }
                            });
